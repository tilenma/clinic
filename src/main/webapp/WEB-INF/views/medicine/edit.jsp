...
<html>
<head>
<title>更改方藥:${medicineForm.name}(${medicineForm.code}) </title>
<meta charset="utf-8">
<jsp:include page="../common.jsp" />
</head>
<body>
	<form:form action="./medicine/edit" commandName="medicineForm" method="post">	
		<div class="row">
	...
	<div class="container-fluid backpink">
		<div class="row">
			...
			<div class="col-md-4 narrow">
				<form:input type="number" placeholder="0.00" min="0" step="0.5" path="referenceUnit"></form:input>
			</div>
		</div>
		<br/>
		<div class="row">
