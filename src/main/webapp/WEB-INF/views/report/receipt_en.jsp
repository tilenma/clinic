...
<html>
<head>
<title>Medical Receipt(${report.wrappedCaseID})</title>
<meta charset="utf-8">
...
<body>	
	...
	<div class="container-fluid ">
		<div class="row">
			<div class="text-center"><h4><b>Medical Receipt</b></h4></div>	
		</div>	
		<div class="row">			
			...
			She is diagnosed as <u>${report.sickness}</u>. The treatment cost <u>${report.price}</u> is received.</div>
		</div>	
	</div>
	<br/>	
	<div class="container-fluid ">
