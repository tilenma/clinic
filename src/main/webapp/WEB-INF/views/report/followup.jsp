...
<html>
<head>
<title>到診紙(${report.wrappedCaseID})</title>
<meta charset="utf-8">
...
<body>	
	...
	<div class="container-fluid ">
		<div class="row">
			<div class="text-center"><h4><b>到診紙</b></h4></div>	
		</div>	
		<div class="row">			
			<div class="col-lg-10 col-md-10 col-xs-10 reportcontent narrow">茲證明<u>${report.customerName}</u>於<u>${report.displayDateWithMarker}</u>在本診所接受診治。
			</div>
		</div>
		<div class="row">
			<div class="col-lg-10 col-md-10 col-xs-10  reportcontent narrow">	
				診斷為<u>${report.sickness}</u>。
			</div>
		</div>		
		<br/>
		<br/>	
		<c:if test="${not empty report.followupRemark }">
		<div class="row">
			<div class="col-lg-10 col-md-10 col-xs-10  reportcontent">備註：&nbsp;&nbsp;${report.followupRemark }</div>			
		</div>				
		<br/>	
		</c:if>	
	</div>
