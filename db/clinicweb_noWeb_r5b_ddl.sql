--web 1.1
alter table "Cases" add column "search_right" VARCHAR(200) NOT NULL DEFAULT 'ziv';
alter table "Cases" add column "view_right" VARCHAR(200) NOT NULL DEFAULT 'ziv';
alter table "Cases" add column "edit_right" VARCHAR(200) NOT NULL DEFAULT 'ziv';
...
CREATE OR REPLACE VIEW "View_Cases" AS 
 ...
 CREATE TABLE "users" (
  ...
  ALTER SEQUENCE medicine_id_seq RESTART with 500; 
...
INSERT INTO users(username,password,enabled) VALUES ('ziv','Clinic2019', true);
INSERT INTO users(username,password,enabled) VALUES ('opa','abcd1234', true);
INSERT INTO users(username,password,enabled) VALUES ('ziv2','Clinic2019', true);
INSERT INTO users(username,password,enabled) VALUES ('doc','doc2019', true);
INSERT INTO users(username,password,enabled) VALUES ('suki','abcd1234', true);
...
INSERT INTO user_roles (username, role) VALUES ('suki', 'ROLE_OPA');
...
update users set report_name='嚴允材',report_name_en='Yim Wan Choi',register_no='005410' where username='ziv';
...
--release4c
alter table "CaseMedicine" add column "unit2" VARCHAR(5) NOT NULL DEFAULT 'g';
